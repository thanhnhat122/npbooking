...
public class Statistic {
  ...
  public Statistic(double month1, double month2, double month3, double month4, double month5, double month6, double month7, double month8, double month9, double month10, double month11, double month12, double total) {
    this.month1 = month1;
    this.month2 = month2;
    this.month3 = month3;
    this.month4 = month4;
